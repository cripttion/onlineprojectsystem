...
// console.log(studentData);
  ...
  return (
    <div className="w-full mx-auto mt-16 ">
      {isLoading && <Loader />}
      <center><div className='flex justify-center text-md pt-4 pb-4  text-textColor1 bg-bgBlueDark w-fit p-2 rounded-md hover:cursor-pointer hover:bg-textGray' onClick={handleClick}> Show List</div></center>
