...
const homeData = [
    ...
    {src: teacher, title: 'Project Guides', toRoute: '/g/allProjects',category:['Teacher','Admin'],relatedTo:['Guide']},
    {src: teacher, title: 'Project Reviewes ', toRoute: '/r/allProjects',category:['Teacher','Admin'],relatedTo:['Reviewer']},
    ...
    {src:project,title:'My project',toRoute:'/projects/myProject',category:['Student'],relatedTo:['Students']}
  ];
